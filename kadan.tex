...
Law of Conservation of Energy, which states that energy cannot be created or destroyed but only
transformed from one form to another, to calculate theoretical values for comparison with the
values we got from Tracker Online. We hypothesized that previous usage of the popper, rather
